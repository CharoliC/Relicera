...
public enum RelicRepairParticleStyle {
    ...
    RelicRepairParticleStyle(String serializedName) {
    ...
    public static RelicRepairParticleStyle fromSerializedName(String serializedName) {
        for (RelicRepairParticleStyle style : values()) {
            if (style.serializedName.equals(serializedName)) {
                return style;
            }
        }
        throw new IllegalArgumentException("Unknown relic repair particle style: " + serializedName);
    }
