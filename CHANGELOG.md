...
+ Added Dreamcatcher Box
+ Added a hidden advancement about Dreamcatcher Box
+ Fixed advancement id：advancements.relicera.iluthia_4 -> advancements.relicera.iluthia_final



#### 1.0.1

+ Added icon for Iluthia's Blessing.
+ Added 60 as absorption upper limit to Iluthia's Blessing.
+ Added JEI information of some items.
+ Added some preset slots.